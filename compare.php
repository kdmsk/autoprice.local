            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">Сровнить</li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-image-title">
                                                    <a href="#" class="img-responsive m-b-15"><img  src="assets/img/compare/1.jpg" alt="Compare Product"></a>
                                                    <a href="#" class="category">Camera</a>
                                                    <a href="#" class="title">Zeon Zen 4 Pro</a>
                                                </td>
                                                <td class="product-image-title">
                                                    <a href="#" class="img-responsive m-b-15"><img src="assets/img/compare/2.jpg" alt="Compare Product"></a>
                                                    <a href="#" class="category">Doren</a>
                                                    <a href="#" class="title">Aquet Doren D 420</a>
                                                </td>
                                                <td class="product-image-title">
                                                    <a href="#" class="img-responsive m-b-15"><img  src="assets/img/compare/3.jpg" alt="Compare Product"></a>
